...
public class ElectricCompressorScreen extends AbstractContainerScreen<ElectricCompressorMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Spacecraft.MOD_ID, "textures/gui/electric_compressor_screen.png");
    private EnergyInfoArea energyInfoArea;

    public ElectricCompressorScreen(ElectricCompressorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void renderProgressArrow(PoseStack pPoseStack, int x, int y) {
        if(menu.isCrafting()) {
            blit(pPoseStack, x + 87, y + 28, 177, 0, menu.getScaledProgress(), 25);
        }
    }
